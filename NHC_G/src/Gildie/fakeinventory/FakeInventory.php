...
abstract class FakeInventory extends SimpleInventory implements BlockInventory {
    ...
    public function __construct(Player $player, protected string $title = "Fake Inventory", protected int $size = FakeInventorySize::SMALL_CHEST, protected bool $inventoryBehindPlayer = true) {
    ...
    abstract public function setItems(Player $player) : void;
