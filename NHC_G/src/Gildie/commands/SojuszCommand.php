...
class SojuszCommand extends GuildCommand {
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
        ...
        $sender->sendMessage(Main::format("Zaproszono do sojuszu gildie §8[§9{$aGuild->getTag()}§8]"));

        $aLeader->sendMessage(Main::formatLines(["Gildia §9{$guild->getTag()} §7wyslala prosbe o sojusz", "Uzyj §9/akceptuj §9{$guild->getTag()}§7, aby ja zaakceptowac"]));
    }
}