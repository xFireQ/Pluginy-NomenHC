...
class PrzedluzCommand extends GuildCommand {
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
        ...
        if(!$sender->getInventory()->contains(\pocketmine\item\ItemFactory::getInstance()->get(264, 0, 128))) {
            $sender->sendMessage(Main::format("Do przedluzenia gildii potrzebujesz 2 staki diaxow"));
            return;
        }

        $sender->getInventory()->removeItem(\pocketmine\item\ItemFactory::getInstance()->get(264, 0, 128));
