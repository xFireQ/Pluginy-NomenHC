...
use LightPE_Core\inventory\BeaconInventory;
...
class Beacon extends Spawnable implements InventoryHolder {
	...
	protected $blocks = [\pocketmine\item\ItemIds::IRON_BLOCK, \pocketmine\item\ItemIds::GOLD_BLOCK, \pocketmine\item\ItemIds::DIAMOND_BLOCK, \pocketmine\item\ItemIds::EMERALD_BLOCK];
