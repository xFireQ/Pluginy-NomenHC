...
class EnchantUbForm extends Form {
    ...
    public function __construct() {
        ...
        $data["content"][] = ["type" => "slider", "text" => "§r§8» §9NIEZNISZCZALNOSC §8(§9I§8) - §710 poziom§7!\n§8» §9NIEZNISZCZALNOSC §8(§9II§8) - §720 poziom§7!\n§8» §9NIEZNISZCZALNOSC §8(§9III§8) - §730 poziom§7!\n\n§8» §7Niezniszczalnosc§9", "min" => 1, "max" => 3];
    ...
    if ($data === null) return;
          ...
          if($data[0] == 0) {
              ...
              if($player->getXpLevel() >= 10) {
                        $ench1 = new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 1);
              ...
              if($player->getXpLevel() >= 20) {
                        $ench1 = new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 2);
                        $item->addEnchantment($ench1);
              ...
              if($player->getXpLevel() >= 30) {
                        $ench1 = new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 3);
                        $item->addEnchantment($ench1);
