...
class EnchantFallingForm extends Form {
    ...
    public function __construct() {
        ...
        $data["content"][] = ["type" => "slider", "text" => "§r§8» §9FEATHER FALLING §8(§9I§8) - §710 poziom§7!\n§8» §9FEATHER FALLING§8(§9II§8) - §720 poziom§7!\n\n§8» §7FEATHER FALLING§9", "min" => 1, "max" => 2];
    ...
    if ($data === null) return;
          ...
          if($data[0] == 0) {
              ...
              if($player->getXpLevel() >= 10) {
                        $ench1 = new EnchantmentInstance(Enchantment::getEnchantment(2), 1);
              ...
              if($player->getXpLevel() >= 20) {
                        $ench1 = new EnchantmentInstance(Enchantment::getEnchantment(2), 2);
                        $item->addEnchantment($ench1);
