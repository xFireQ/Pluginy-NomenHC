...
class EnchantPowerForm extends Form {
    ...
    public function __construct() {
        ...
        $data["content"][] = ["type" => "slider", "text" => "§r§8» §9MOC §8(§9I§8) - §710 poziom§7!\n§8» §9MOC §8(§9II§8) - §715 poziom§7!\n§8» §9MOC §8(§9III§8) - §720 poziom§7!\n§8» §9MOC §8(§9IV§8) - §725 poziom§7!\n§8» §9MOC §8(§9V§8) - §730 poziom§7!§r\n\n§8» §7MOC§9", "min" => 1, "max" => 5];
    ...
    if ($data === null) return;
          ...
          if($data[0] == 0) {
              ...
              if($player->getXpLevel() >= 10) {
                        $ench1 = new EnchantmentInstance(Enchantment::getEnchantment(19), 1);
              ...
              if ($item->getId() == 261) {
                  if($player->getXpLevel() >= 15) {
                        $ench1 = new EnchantmentInstance(Enchantment::getEnchantment(19), 2);
                        $item->addEnchantment($ench1);
              ...
              if ($item->getId() == 261) {
                  ...
                  if($player->getXpLevel() >= 20) {
                        $ench1 = new EnchantmentInstance(Enchantment::getEnchantment(19), 3);
                        $item->addEnchantment($ench1);
              ...
              if ($item->getId() == 261) {
                  if($player->getXpLevel() >= 25) {
                        $ench1 = new EnchantmentInstance(Enchantment::getEnchantment(19), 4);
                        $item->addEnchantment($ench1);
              ...
              if ($item->getId() == 261) {
                  if($player->getXpLevel() >= 30) {
                        $ench1 = new EnchantmentInstance(Enchantment::getEnchantment(19), 5);
                        $item->addEnchantment($ench1);
